        ...
        let FindForm = (
                <div id="find_pw_phone_form">
                    <form onSubmit={this.handlePhoneNumber}>
                        <label>
                            <input type="number" name={"phoneNumber"} value={this.state.phoneNumber} placeholder={this.props.enter_phone}
        ...
        return (
            <div>
                ...
                <div id = "select_type_info">
                    <h3 style = {{borderColor : "#000000"}}><a className = "pw_link" href = {link.findpw}>{this.props.find_with_phone}</a></h3>
                    <h3><a className = "pw_link" href = {link.findpwemail}>{this.props.find_with_email}</a></h3>
                </div>
                <div>
                    {FindForm}
                </div>
